...
},{"jquery":6,"underscore":2}],2:[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{"dup":1,"jquery":6,"underscore":5}],5:[function(require,module,exports){
...
require('./todos/todo-model');

require('./todos/todo-view');

var _todosTodosView = require('./todos/todos-view');

var _todosTodosView2 = _interopRequireDefault(_todosTodosView);

var _todosFilters = require('./todos/filters');

var _todosFilters2 = _interopRequireDefault(_todosFilters);

(0, _jquery2['default'])(function () {
  new _todosTodosView2['default']();
  new _todosFilters2['default']();
  _backbone2['default'].history.start();
});

},{"./todos/filters":9,"./todos/todo-model":10,"./todos/todo-view":11,"./todos/todos-view":13,"backbone":4,"jquery":6}],9:[function(require,module,exports){
'use strict';
...
var _todosView = require('./todos-view');
...
var Filters = (function (_Router) {
  _inherits(Filters, _Router);

  function Filters() {
    _classCallCheck(this, Filters);

    _get(Object.getPrototypeOf(Filters.prototype), 'constructor', this).call(this);
    this.routes = {
      '*filter': 'filter'
    };
  ...
  _createClass(Filters, [{
    ...
    value: function filter() {
      ...
      exports.TodoFilter = TodoFilter = param;

      // *Trigger a collection filter event, causing hiding/unhiding
      // of Todo view items.*
      _todosView.Todos.trigger('filter');
    }
  }]);
...
},{"./todos-view":13,"backbone":4}],10:[function(require,module,exports){
'use strict';
...
var TodoModel = (function (_Model) {
  ...
  function TodoModel() {
    ...
    _get(Object.getPrototypeOf(TodoModel.prototype), 'constructor', this).apply(this, arguments);
  }
...
},{"backbone":4}],11:[function(require,module,exports){
'use strict';
...
var TodoView = (function (_View) {
  ...
  function TodoView(options) {
    ...
    _get(Object.getPrototypeOf(TodoView.prototype), 'constructor', this).call(this, options);
    // *... is a list tag.*
    this.tagName = 'li';
    console.log(this.model);
    // *Cache the template function for a single item.*
    this.template = _underscore2['default'].template((0, _jquery2['default'])('#item-template').html());
  ...
  _createClass(TodoView, [{
    ...
    value: function updateOnEnter(e) {
      if (e.which === _todosView.ENTER_KEY) {
        this.close();
      }
    }
    ...
    get: function get() {
      ...
      return (// hidden cases only
        !isCompleted && _filters.TodoFilter === 'completed' || isCompleted && _filters.TodoFilter === 'active'
      );
    }
  }]);
...
},{"./filters":9,"./todos-view":13,"Backbone":1,"jquery":6,"underscore":7}],12:[function(require,module,exports){
'use strict';
...
var _backboneLocalstorage = require('backbone.localstorage');
...
var TodoList = (function (_Collection) {
  _inherits(TodoList, _Collection);
  ...
  function TodoList(options) {
    ...
    _get(Object.getPrototypeOf(TodoList.prototype), 'constructor', this).call(this, options);

    // *Hold a reference to this collection's model.*
    this.model = _todoModel2['default'];

    // *Save all of the todo items under the `'todos'` namespace.*
    this.localStorage = new _backboneLocalstorage2['default']('backbone-todo');
  }
  ...
  _createClass(TodoList, [{
    ...
    value: function remaining() {
      ...
      // (`this` in our case).
      return this.without.apply(this, _toConsumableArray(this.completed()));
    }
...
},{"./todo-model":10,"backbone":4,"backbone.localstorage":3}],13:[function(require,module,exports){
'use strict';
...
var _todosCollection = require('./todos-collection');

var _todosCollection2 = _interopRequireDefault(_todosCollection);

var ENTER_KEY = 13;
exports.ENTER_KEY = ENTER_KEY;
var Todos = new _todosCollection2['default']();
...
var TodoListView = (function (_View) {
  ...
  function TodoListView() {
    ...
    _get(Object.getPrototypeOf(TodoListView.prototype), 'constructor', this).call(this);
    // *Instead of generating a new element, bind to the existing skeleton of
    // the App already present in the HTML.*
    this.setElement((0, _jquery2['default'])('#todoapp'), true);

    this.statsTemplate = _underscore2['default'].template((0, _jquery2['default'])('#stats-template').html()),
  ...
  _createClass(TodoListView, [{
    ...
    value: function addOne(model) {
      var view = new _todoView2['default']({ model: model }); // const
      (0, _jquery2['default'])('#todo-list').append(view.render().el);
    }
    ...
    value: function clearCompleted() {
      _underscore2['default'].invoke(Todos.completed(), 'destroy');
      return false;
    }
  }, {
...
},{"./todo-view":11,"./todos-collection":12,"backbone":4,"jquery":6,"underscore":7}]},{},[8]);
